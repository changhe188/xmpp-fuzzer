/**
 * $RCSfile: fuzzPresence.java,v $
 * $Revision: 1.1 $
 * $Date: 2009/06/29 15:46:27 $
 *
 ...
 * @author Matt Tucker
 */
public class fuzzPresence extends Packet {
     ...
     */
    public fuzzPresence(Type type, String status, int priority, Mode mode) {
        setType(type);
        setStatus(status);
