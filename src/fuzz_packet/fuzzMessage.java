/**
 * $RCSfile: fuzzMessage.java,v $
 * $Revision: 1.1 $
 * $Date: 2009/06/29 15:46:42 $
 *
 ...
 * @author Matt Tucker
 */
public class fuzzMessage extends Packet {
     ...
     */
    public fuzzMessage(String to, Type type) {
        setTo(to);
        this.type = type;
    }
    ...
    public boolean equals(Object o) {
        ...
        fuzzMessage message = (fuzzMessage) o;
